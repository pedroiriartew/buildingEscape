...
#include "GameFramework/PlayerController.h"
	...
	//OpenDoor.Yaw = FMath::Lerp(CurrentYaw, TargetYaw, 0.02f); //Este lerp hace algo as� como una interpolacion exponencial. No es lo que queremos.
	/*
	FInterpConstantTo es una funcion que interpola el current float con el target float a un ritmo constante
	FInterpTo es m�s Smooth
	*/
